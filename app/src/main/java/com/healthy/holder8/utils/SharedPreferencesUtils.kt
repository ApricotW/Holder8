...
open class SharedPreferencesUtils(context: Context) {
    ...
    var password:String? by SharedPreferenceDelegates.string()

    var Login_state by SharedPreferenceDelegates.boolean()

    var checkbox_state by SharedPreferenceDelegates.boolean()

    var password_temp:String? by SharedPreferenceDelegates.string()

    var count by SharedPreferenceDelegates.int()

    var phone by SharedPreferenceDelegates.string()
